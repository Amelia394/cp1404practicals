...
#print("My guitars.csv: " + name + ", first made in " + str(year))

# A better way - using str.format() (don't do this unless you need to):
#print("My guitars.csv: {}, first made in {}".format(name, year))
# print("My guitars.csv: {0}, first made in {1}".format(name, year))
...
# DONE: Using a for loop with the range function and f-string formatting,
for i in range(11):
