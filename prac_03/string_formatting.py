...
#print("My guitar.csv: " + name + ", first made in " + str(year))

# A better way - using str.format() (don't do this unless you need to):
#print("My guitar.csv: {}, first made in {}".format(name, year))
# print("My guitar.csv: {0}, first made in {1}".format(name, year))
